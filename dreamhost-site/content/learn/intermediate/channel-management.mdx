...
- **Liquidity Marketplaces**: Buy inbound directly — see [Sourcing Lightning Liquidity](/learn/advanced/liquidity-sourcing) for how Amboss Magma, Lightning Pool, and LSPs compare
- **Dual-Funded Channels**: Split the cost with your peer
- **Splicing**: Add capacity to an existing channel without closing it (Core Lightning default as of 2026)
