...
tags: ['lightning', 'liquid', 'spark', 'ark', 'ecash', 'cashu', 'fedimint', 'l2', 'scaling', 'boltz']
...
**Ark** — Non-custodial (self-exit), ASP trust (reputational). ~5 second rounds. Can receive offline. No liquidity management. Early production (2025). Best for: users who don't want to manage channels.
